...
export default function FloatingCTA() {
  return (
    <div className="floating-wa" aria-label="Chat on WhatsApp">
      <span className="floating-wa__label" aria-hidden="true">Chat with us!</span>
      <a
        className="floating-wa__btn"
        href={`https://wa.me/${WHATSAPP_NUMBER}?text=${message}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Open WhatsApp chat with Loom Digital"
